...
var JSON2CSVBase = function () {
  ...
  createClass(JSON2CSVBase, [{
    ...
    value: function unwindData(dataRow, unwindPaths) {
      return unwindPaths.reduce(function (data, unwindPath) {
        return data.map(function (dataEl) {
          var unwindArray = lodash_get(dataEl, unwindPath);
          ...
          if (unwindArray.length) {
            return unwindArray.map(function (unwindEl) {
              var dataCopy = lodash_clonedeep(dataEl);
              lodash_set(dataCopy, unwindPath, unwindEl);
              return dataCopy;
            });
          }

          var dataCopy = lodash_clonedeep(dataEl);
          lodash_set(dataCopy, unwindPath, undefined);
          return dataCopy;
        }).reduce(function (tempData, rows) {
          return tempData.concat(rows);
        }, []);
      }, [dataRow]).reduce(function (tempData, rows) {
        return tempData.concat(rows);
      }, []);
    }
  }]);
...
var Transform$1 = JSON2CSVTransform_1;
...
export { Parser$1 as Parser, Transform$1 as Transform, parse };
